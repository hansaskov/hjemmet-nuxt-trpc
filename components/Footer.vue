...
<footer class="flex flex-col items-center justify-between p-6 bg-background-light dark:bg-background-dark sm:flex-row">
    
    <p class="text-sm text-gray-600 dark:text-gray-300">Website made by Hans Askov</p>
    ...
    <div class="flex -mx-2">
        <a href="#" class="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Facebook">
            <svg class="w-4 h-5 fill-current" viewBox="0 0 24 24" fill="none"
